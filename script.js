...
document.addEventListener("DOMContentLoaded", function() {
    ...
    addHoverEffect(".nav-dev-btn", { transform: "translateY(-3px) scale(1.05)", opacity: "1" }, { transform: "translateY(0) scale(1)", opacity: "0.6" });
    ...
    pulseEffect(".nav-dev-btn", { opacity: "0.8" }, 4000);
