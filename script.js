...
const OPENROUTER_API_KEY = "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";
...
obaydaForm.addEventListener("submit", async (e) => {
  ...
  try {
    ...
    typingEl.remove();
    addObaydaMsg("حدث خطأ في الاتصال. تأكد من صلاحية مفتاح API واتصالك بالإنترنت، ثم حاول مجدداً.", "error");
